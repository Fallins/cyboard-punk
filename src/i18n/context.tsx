...
type CopyKey =
  ...
  | 'tokenActivity' | 'tokenTelemetry' | 'sources' | 'noData' | 'usageUnavailable' | 'noReliableTokenData'
  | 'noReliableTokenDataHelp' | 'tokens' | 'measured' | 'tokenBreakdown' | 'inputTokens'
  ...
  | 'characterStageControls' | 'lockCharacterView' | 'unlockCharacterView' | 'resetCharacterView'
  | 'openDesktopCharacter';
...
const en: Record<CopyKey, string> = {
  ...
  tokenActivity: 'Token Activity', tokenTelemetry: 'TOKEN TELEMETRY', sources: '{count} SOURCES', noData: 'NO DATA', usageUnavailable: 'Reliable token telemetry will appear here when a provider exposes it.', noReliableTokenData: 'No reliable token data yet', noReliableTokenDataHelp: 'CYBOARD only shows provider-supplied or locally verifiable token data; missing usage is never estimated.', tokens: 'tokens', measured: 'measured', tokenBreakdown: '{provider} token breakdown', inputTokens: 'INPUT', cacheReadTokens: 'CACHE READ', cacheWriteTokens: 'CACHE WRITE', outputTokens: 'OUTPUT',
  ...
  systemConfig: 'SYSTEM CONFIG', language: 'Language', languageHelp: 'Choose the language used across CYBOARD.', experience: 'Experience', operator: 'Character', operatorHelp: 'Show NYX on the primary stage or hide the character.', nyxTestControls: 'NYX test controls', nyxTestHelp: 'Show local diagnostics for NYX motion and state testing.', autoRefresh: 'Auto refresh', autoRefreshHelp: 'Native provider throttles still protect upstream endpoints.', quotaNotifications: 'Quota notifications', notificationStyle: 'Notification style', notificationStyleHelp: 'Changes wording only; alert thresholds and timing stay the same.', systemStyle: 'System', nyxStyle: 'NYX', minimalStyle: 'Minimal', resetReminder: 'Reset reminder', resetReminderHelp: 'Notify before a known quota reset while CYBOARD is running.', launchAtLogin: 'Launch at login', launchAtLoginHelp: 'Start CYBOARD with macOS and keep it available from the menu bar.', off: 'Off', seconds30: '30S', minute1: '1M', minutes3: '3M', minutes5: '5M', minutes10: '10M', minutes30: '30M', hour1: '1H', closeSettings: 'Close settings', enabledProvidersHelp: 'Only enabled providers appear in quota, routing, trend, session and notification surfaces.', operatorDisabled: 'CYBOARD character hidden', operatorLoading: 'CYBOARD character loading', noProviderBridge: 'Native provider bridge unavailable. Launch CYBOARD through the Tauri desktop shell.', providersCount: '{count} PROVIDERS', activeCount: '{count} ACTIVE', brief: 'BRIEF', fallback: 'FALLBACK', quotaHeadroom: '{value} percent quota headroom',
  stateIdle: 'IDLE', stateObserve: 'OBSERVE', stateProcess: 'PROCESS', stateWarning: 'WARNING', stateSuccess: 'SUCCESS', stateOffline: 'OFFLINE', attention: 'ATTENTION', center: 'CENTER', motionTuning: 'NYX motion tuning', resetTuning: 'RESET TUNING', nyxRuntimeSimulator: 'NYX runtime state simulator', characterStageControls: 'Character stage controls', lockCharacterView: 'Lock character view', unlockCharacterView: 'Unlock character view', resetCharacterView: 'Reset character view', openDesktopCharacter: 'Show character on desktop',
};

const zh: Record<CopyKey, string> = {
  settings: '設定', refresh: '更新', syncing: '同步中', connecting: '連線中', localMonitor: '本機監控', providersReady: '{ready}/{total} 個 Provider 就緒',
  ...
  resourceMatrix: '資源狀態', activeAgents: '活躍 Agent', sessionRunning: '個工作階段執行中', sessionsRunning: '個工作階段執行中', providerHealth: 'Provider 狀態與即時工作階段',
  liveOperations: '即時作業', agentSessions: 'Agent 工作階段', allAgentsStandby: '所有 Agent 待命', sessionsAutoAppear: '有執行中的工作階段時會自動顯示。',
  ...
  tokenActivity: 'Token 活動', tokenTelemetry: 'Token 資料', sources: '{count} 個來源', noData: '無資料', usageUnavailable: 'Provider 提供可靠 Token 資料後會顯示於此。', noReliableTokenData: '暫無可靠 Token 資料', noReliableTokenDataHelp: 'CYBOARD 只顯示 Provider 實際提供或本機可驗證的 Token，不會估算。', tokens: 'Token', measured: '實測', tokenBreakdown: '{provider} Token 明細', inputTokens: '輸入', cacheReadTokens: '快取讀取', cacheWriteTokens: '快取寫入', outputTokens: '輸出',
  modelMix: '模型分布', projectUnavailable: '此資料沒有可靠的 Project 歸屬。', latestActivity: '最近活動 {time}', recentCloseouts: '最近結束', observedLifecycle: '工作階段追蹤',
  ...
  quotaUnavailable: 'N/A · 無額度資料', openDashboard: '開啟儀表板', opening: '開啟中', commandLink: '快速面板', providers: 'Provider', ready: '就緒', active: '執行中', quotaSummary: 'Provider 額度摘要', statusSummary: 'CYBOARD 狀態摘要', openingDashboard: '正在開啟儀表板', refreshingQuotas: '正在更新 Provider 額度',
  systemConfig: '系統設定', language: '語言', languageHelp: '切換 CYBOARD 顯示語言。', experience: '體驗', operator: '角色', operatorHelp: '在主舞台顯示 NYX，或暫時隱藏角色。', nyxTestControls: 'NYX 測試控制', nyxTestHelp: '顯示 NYX 動作與狀態診斷。', autoRefresh: '自動更新', autoRefreshHelp: 'Provider 端仍有節流保護。', quotaNotifications: '額度通知', notificationStyle: '通知風格', notificationStyleHelp: '只改文案，不改門檻與通知時間。', systemStyle: '系統', nyxStyle: 'NYX', minimalStyle: '極簡', resetReminder: '重置提醒', resetReminderHelp: '已知額度即將重置時提前通知。', launchAtLogin: '開機啟動', launchAtLoginHelp: '登入 macOS 後自動啟動 CYBOARD。', off: '關閉', seconds30: '30s', minute1: '1min', minutes3: '3min', minutes5: '5min', minutes10: '10min', minutes30: '30min', hour1: '1h', closeSettings: '關閉設定', enabledProvidersHelp: '只有啟用的 Provider 會出現在額度、推薦、趨勢、工作階段與通知。', operatorDisabled: 'CYBOARD 角色已隱藏', operatorLoading: 'CYBOARD 角色載入中', noProviderBridge: '無法連接 Native Provider；請從 Tauri App 啟動 CYBOARD。', providersCount: '{count} 個 Provider', activeCount: '{count} 個活躍 Agent', brief: '摘要', fallback: '備援', quotaHeadroom: '額度餘裕 {value}%',
  stateIdle: '待命', stateObserve: '觀察', stateProcess: '處理', stateWarning: '警告', stateSuccess: '完成', stateOffline: '離線', attention: '焦點', center: '中央', motionTuning: 'NYX 動作調整', resetTuning: '重設調整', nyxRuntimeSimulator: 'NYX 狀態模擬器', characterStageControls: '角色舞台控制', lockCharacterView: '鎖定角色視角', unlockCharacterView: '解除鎖定角色視角', resetCharacterView: '回復角色視角', openDesktopCharacter: '在桌面顯示角色',
};
...
export function I18nProvider(props: { language: AppLanguage | Accessor<AppLanguage>; children: JSX.Element }) {
  const language: Accessor<AppLanguage> = () => {
