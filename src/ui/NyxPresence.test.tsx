...
vi.mock('./NyxVrmRuntime', () => ({
  default: (props: { cameraView: unknown }) => (
    <div data-testid="nyx-vrm-runtime" data-camera-view={JSON.stringify(props.cameraView)} />
  ),
}));
...
describe('NyxPresence', () => {
  it('uses the app camera view and exposes native move, resize, and hide controls', async () => {
    ...
    await fireEvent.pointerDown(container.querySelector('.nyx-presence__drag-region') as HTMLElement, { button: 0 });
